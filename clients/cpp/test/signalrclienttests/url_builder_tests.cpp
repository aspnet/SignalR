...
TEST(url_builder_negotiate, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_negotiate(web::uri{ _XPLATSTR("http://fake/signalr/") }, _XPLATSTR(""), _XPLATSTR("")));
}
...
TEST(url_builder_negotiate, url_correct_if_query_string_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_negotiate(web::uri{ _XPLATSTR("http://fake/signalr/") }, _XPLATSTR(""), _XPLATSTR("q1=1&q2=2")));
...
TEST(url_builder_negotiate, url_correct_if_connection_data_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_negotiate(web::uri{ _XPLATSTR("http://fake/signalr/") }, _XPLATSTR("[{\"Name\":\"ChatHub\"}]"), _XPLATSTR("")));
}
...
TEST(url_builder_connect_longPolling, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
...
TEST(url_builder_connect_webSockets, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::websockets,
            _XPLATSTR("connection token"), _XPLATSTR("")));

    ASSERT_EQ(
        web::uri(_XPLATSTR("wss://fake/signalr/connect?transport=webSockets&clientProtocol=1.4&connectionToken=connection%20token")),
        url_builder::build_connect(web::uri{ _XPLATSTR("https://fake/signalr/") }, transport_type::websockets,
            _XPLATSTR("connection token"), _XPLATSTR("")));
}
...
TEST(url_builder_connect, url_correct_if_connection_data_not_empty)
{
    ASSERT_EQ(
        web::uri(_XPLATSTR("http://fake/signalr/connect?transport=longPolling&clientProtocol=1.4&connectionToken=connection%20token&connectionData=%5B%7B%22Name%22:%22ChatHub%22%7D%5D")),
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection token"), _XPLATSTR("")));

    ASSERT_EQ(
        web::uri(_XPLATSTR("ws://fake/signalr/connect?transport=webSockets&clientProtocol=1.4&connectionToken=connection%20token&connectionData=%5B%7B%22Name%22:%22ChatHub%22%7D%5D")),
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::websockets,
        _XPLATSTR("connection token"), _XPLATSTR("")));
}
...
TEST(url_builder_reconnect_longPolling, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        _XPLATSTR("connection token"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("")));
}
...
TEST(url_builder_reconnect_longPolling, url_correct_if_query_string_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection-token"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("q1=1&q2=2")));
...
TEST(url_builder_reconnect_webSockets, url_correct_if_query_string_empty)
{
    ...
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("https://fake/signalr/") }, transport_type::websockets,
        _XPLATSTR("connection token"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("")));
}
