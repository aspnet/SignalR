...
class WebSocketTransportTest {
    ...
    public void WebsocketThrowsIfItCantConnect() throws Exception {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> transport.start("http://www.example.com").firstElement().timeout(1, TimeUnit.SECONDS).blockingGet());
