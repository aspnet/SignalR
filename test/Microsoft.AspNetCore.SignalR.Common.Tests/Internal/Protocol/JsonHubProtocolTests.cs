...
namespace Microsoft.AspNetCore.SignalR.Common.Tests.Internal.Protocol
{
    ...
    public class JsonHubProtocolTests
    {
        ...
        public static IDictionary<string, JsonProtocolTestData> ProtocolTestData => new[]
        {
            ...
            new JsonProtocolTestData("InvocationMessage_UploadStreamingFlag", new InvocationMessage("123", "Target", new object[] { }, true), true, NullValueHandling.Ignore, "{\"type\":1,\"invocationId\":\"123\",\"target\":\"Target\",\"arguments\":[],\"streamingUpload\":true}"),
