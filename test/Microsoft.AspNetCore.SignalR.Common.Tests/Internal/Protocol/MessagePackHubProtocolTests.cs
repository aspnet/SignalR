...
namespace Microsoft.AspNetCore.SignalR.Common.Tests.Internal.Protocol
{
    public class MessagePackHubProtocolTests
    {
        ...
        {
            new object[] { new[] { new InvocationMessage("xyz", "method", null) } },
            new object[] { new[] { new InvocationMessage(null, "method", null) } },
            new object[] { new[] { new InvocationMessage(null, "method", null, new object[] { null }) } },
            new object[] { new[] { new InvocationMessage(null, "method", null, 42) } },
            new object[] { new[] { new InvocationMessage(null, "method", null, 42, "string") } },
            new object[] { new[] { new InvocationMessage(null, "method", null, 42, "string", new CustomObject()) } },
            new object[] { new[] { new InvocationMessage(null, "method", null, new[] { new CustomObject(), new CustomObject() }) } },
