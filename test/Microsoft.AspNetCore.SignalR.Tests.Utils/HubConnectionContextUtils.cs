...
namespace Microsoft.AspNetCore.SignalR.Tests
{
    ...
    {
        public static HubConnectionContext Create(TestConnectionContext connection)
        {
        ...
        public static Mock<HubConnectionContext> CreateMock(TestConnectionContext connection)
        {
