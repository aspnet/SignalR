...
namespace Microsoft.AspNetCore.Http.Connections.Tests
{
    public class NegotiateProtocolTests
    {
        ...
        public void ParsingClassicSignalRResponseThrowsError()
        {
            ...
            Assert.Equal("It seems like you are trying to connect to an ASP.NET SignalR Server. This client only supports connecting to an ASP.NET Core SignalR Server.", exception.InnerException.Message);
        }
