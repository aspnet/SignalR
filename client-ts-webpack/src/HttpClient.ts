...
export class HttpClient implements IHttpClient {
    public get(url: string, headers?: Map<string, string>): Promise<string> {
        return this.xhr('GET', url, headers);
    }

    public options(url: string, headers?: Map<string, string>): Promise<string> {
        return this.xhr('OPTIONS', url, headers);
    }

    public post(url: string, content: string, headers?: Map<string, string>): Promise<string> {
