...
export class HttpConnection implements IConnection {
    ...
    async start(isBinary: boolean): Promise<void> {
        ...
        this.startPromise = this.startInternal(isBinary);
        return this.startPromise;
    }

    private async startInternal(isBinary: boolean): Promise<void> {
        try {
            ...
            await this.transport.connect(this.url, isBinary);
