        ...
        public void GlobalSetup()
        {
            ...
            switch (Input)
            {
                case Message.NoArguments:
                    _hubMessage = new InvocationMessage(null, "Target", null);
                    break;
                case Message.FewArguments:
                    _hubMessage = new InvocationMessage(null, "Target", null, 1, "Foo", 2.0f);
                    break;
                case Message.ManyArguments:
                    _hubMessage = new InvocationMessage(null, "Target", null, 1, "string", 2.0f, true, (byte)9, new byte[] { 5, 4, 3, 2, 1 }, 'c', 123456789101112L);
                    break;
                case Message.LargeArguments:
                    _hubMessage = new InvocationMessage(null, "Target", null, new string('F', 10240), new byte[10240]);
                    break;
            }
