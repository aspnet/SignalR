...
namespace Microsoft.AspNetCore.Sockets.HttpServer
{
    public static class PipelineExtensions
    {
        ...
        public unsafe static void WriteAsciiNoValidation(ref WritableBuffer buffer, string data)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe static void WriteNumeric(ref WritableBuffer buffer, ulong number)
        {
        ...
        private static void WriteNumericMultiWrite(ref WritableBuffer buffer, ulong number)
        {
            const byte AsciiDigitStart = (byte)'0';
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private unsafe static void WriteAsciiMultiWrite(ref WritableBuffer buffer, string data)
        {
