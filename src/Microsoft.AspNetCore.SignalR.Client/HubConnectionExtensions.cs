...
namespace Microsoft.AspNetCore.SignalR.Client
{
    ...
    {
        private static void On(this HubConnection hubConnection, string methodName, Type[] parameterTypes, Action<object[]> handler)
        {
            ...
            hubConnection.On(methodName, parameterTypes, typeof(void), args =>
            {
                handler(args);
