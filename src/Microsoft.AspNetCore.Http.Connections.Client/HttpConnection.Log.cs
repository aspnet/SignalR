...
namespace Microsoft.AspNetCore.Http.Connections.Client
{
    public partial class HttpConnection
    {
        private static class Log
        {
            ...
            public static void StartingTransport(ILogger logger, HttpTransportTypes transportType, Uri url)
            {
            ...
            public static void TransportDoesNotSupportTransferFormat(ILogger logger, HttpTransportTypes transport, TransferFormat transferFormat)
            {
                if (logger.IsEnabled(LogLevel.Debug))
                {
            ...
            public static void TransportDisabledByClient(ILogger logger, HttpTransportTypes transport)
            {
                if (logger.IsEnabled(LogLevel.Debug))
                {
            ...
            public static void TransportFailed(ILogger logger, HttpTransportTypes transport, Exception ex)
            {
                if (logger.IsEnabled(LogLevel.Debug))
                {
