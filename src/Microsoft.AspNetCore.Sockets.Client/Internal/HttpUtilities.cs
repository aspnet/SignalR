...
namespace Microsoft.AspNetCore.Sockets.Client.Internal
{
    public static class HttpUtilities
    {
        ...
        private static string[] CreateMethodNames()
        {
            ...
            methodNames[(byte)HttpMethod.Get] = "GET";
            methodNames[(byte)HttpMethod.Put] = "PUT";
            methodNames[(byte)HttpMethod.Delete] = "DELETE";
            methodNames[(byte)HttpMethod.Post] = "POST";
            methodNames[(byte)HttpMethod.Head] = "HEAD";
            methodNames[(byte)HttpMethod.Trace] = "TRACE";
            methodNames[(byte)HttpMethod.Patch] = "PATCH";
            methodNames[(byte)HttpMethod.Connect] = "CONNECT";
            methodNames[(byte)HttpMethod.Options] = "OPTIONS";
            return methodNames;
        }
        ...
        internal unsafe static HttpVersion GetKnownVersion(byte* location, int length)
        {
            ...
            if (length < sizeof(ulong) + 1 || location[sizeof(ulong)] != (byte)' ')
            {
