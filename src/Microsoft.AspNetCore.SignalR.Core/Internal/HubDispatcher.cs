...
{
    public partial class HubDispatcher<THub> : IInvocationBinder where THub : Hub
    {
        ...
        public HubDispatcher(IServiceScopeFactory serviceScopeFactory, IHubContext<THub> hubContext, ILogger<HubDispatcher<THub>> logger)
        {
        ...
        public virtual async Task OnConnectedAsync(HubConnectionContext connection)
        {
            try
            {
        ...
        public virtual async Task OnDisconnectedAsync(HubConnectionContext connection, Exception exception)
        {
            try
            {
                using (var scope = _serviceScopeFactory.CreateScope())
        ...
        public virtual async Task DispatchMessageAsync(HubConnectionContext connection, HubMessage hubMessage)
        {
            switch (hubMessage)
            {
