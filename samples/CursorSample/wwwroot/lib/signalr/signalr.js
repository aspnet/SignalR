...
var Errors_3 = Errors.AbortError;
...
var HubConnection = /** @class */ (function () {
    function HubConnection(connection, logger, protocol) {
        ...
        this.cachedPingMessage = this.protocol.writeMessage({ type: IHubProtocol.MessageType.Ping });
    }
    /** @internal */
    ...
    HubConnection.prototype.resetKeepAliveInterval = function () {
        var _this = this;
        this.cleanupPingTimer();
        this.pingServerHandle = setTimeout(function () { return _this.sendMessage(_this.cachedPingMessage); }, this.keepAliveIntervalInMilliseconds);
    };
...
var HubConnection_2 = HubConnection_1.HubConnectionState;
...
var LongPollingTransport = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.statusCode !== 200) {
                            ...
                            this.closeError = new Errors.HttpError(response.statusText || "", response.statusCode);
                            this.running = false;
                        }
                        else {
                            this.running = true;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        this.logger.log(ILogger.LogLevel.Trace, "(LongPolling transport) Polling complete.");
    ...
    LongPollingTransport.prototype.stop = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logger.log(ILogger.LogLevel.Trace, "(LongPolling transport) Stopping polling.");
                    ...
                    case 4:
                        _a.sent();
                        this.logger.log(ILogger.LogLevel.Trace, "(LongPolling transport) DELETE request sent.");
                        return [3 /*break*/, 6];
                    case 5:
                        this.logger.log(ILogger.LogLevel.Trace, "(LongPolling transport) Stop finished.");
    ...
    LongPollingTransport.prototype.raiseOnClose = function () {
        if (this.onclose) {
            ...
            this.logger.log(ILogger.LogLevel.Trace, logMessage);
...
var HttpConnection = /** @class */ (function () {
    ...
    HttpConnection.prototype.getNegotiationResponse = function (url) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var headers, token, negotiateUrl, response, e_3, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.accessTokenFactory) return [3 /*break*/, 2];
        ...
        if (transport === null || transport === undefined) {
            ...
            if (transportMatches(requestedTransport, transport)) {
                if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                    if ((transport === ITransport.HttpTransportType.WebSockets && !this.options.WebSocket) ||
                        (transport === ITransport.HttpTransportType.ServerSentEvents && !this.options.EventSource)) {
...
var cjs_2 = cjs.AbortError;
var cjs_3 = cjs.HttpError;
var cjs_4 = cjs.TimeoutError;
var cjs_5 = cjs.DefaultHttpClient;
var cjs_6 = cjs.HttpClient;
var cjs_7 = cjs.HttpResponse;
var cjs_8 = cjs.HubConnection;
var cjs_9 = cjs.HubConnectionState;
var cjs_10 = cjs.HubConnectionBuilder;
var cjs_11 = cjs.MessageType;
var cjs_12 = cjs.LogLevel;
var cjs_13 = cjs.HttpTransportType;
var cjs_14 = cjs.TransferFormat;
var cjs_15 = cjs.NullLogger;
var cjs_16 = cjs.JsonHubProtocol;
